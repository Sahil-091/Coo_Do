...
export const CONSENT_ITEMS: { type: ConsentType; title: string; description: string }[] = [
  ...
  {
    type: "activity_alerts",
    title: "Local activity alerts",
    description: "Lets us use a server-coarsened area cell to alert you to relevant public-venue activities nearby. Your exact location is never stored or shown.",
  },
  {
