...
export function DataRequestSection({ initialRequests, scope }: { initialRequests: DataRequestItem[]; scope?: "journal" }) {
  ...
  function handleRequest(type: "export" | "deletion") {
    ...
    startTransition(async () => {
      ...
      if (scope) formData.set("dataScope", scope);
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-2 sm:flex-row">
        ...
        >
          {pendingExport ? "Export requested" : scope ? "Request journal export" : "Request my data"}
        </Button>
        <Button
          type="button"
        ...
        >
          {pendingDeletion ? "Deletion requested" : scope ? "Request journal deletion" : "Request account deletion"}
        </Button>
      </div>
