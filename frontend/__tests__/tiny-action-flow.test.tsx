...
const LADDER: TinyActionRung[] = [
  { id: "rung-1", difficultyLevel: 1, title: "Step outside for 2 minutes", description: "Just do it.", voiceMessage: "Just do it." },
  { id: "rung-2", difficultyLevel: 2, title: "Go where people are", description: "Head somewhere.", voiceMessage: "Head somewhere." },
  { id: "rung-3", difficultyLevel: 3, title: "Message one classmate", description: "Send a message.", voiceMessage: "Send a message." },
];
...
describe("TinyActionFlow", () => {
  ...
  test("starts on the middle (difficulty 2) rung by default", () => {
    ...
    expect(screen.getByText("Head somewhere.")).toBeInTheDocument();
  });
  ...
  test("'See another' fetches a fresh ladder and resets to its middle rung", async () => {
    const newLadder: TinyActionRung[] = [
      { id: "new-1", difficultyLevel: 1, title: "Roll your shoulders", description: "Ten seconds.", voiceMessage: "Ten seconds." },
      { id: "new-2", difficultyLevel: 2, title: "Stretch a few minutes", description: "Right where you are.", voiceMessage: "Right where you are." },
      { id: "new-3", difficultyLevel: 3, title: "Move for 10 minutes", description: "Anything physical.", voiceMessage: "Anything physical." },
    ];
