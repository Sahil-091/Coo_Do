...
class SafetyEvent(Base):
    ...
    # Provider/model and prompt version are retained for auditability when the
    # constrained classifier changes. They do not store model reasoning.
    classifier_model: Mapped[str] = mapped_column(String)
    classifier_prompt_version: Mapped[str] = mapped_column(String)
